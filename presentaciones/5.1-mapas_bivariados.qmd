...
![](imgs/para.png){fig-align="center", fig-size="22%"}

## También usados para reportar indicadores socio-económicos

![](imgs/dengue.png){fig-align="center, fig-size="22%""}
...
-   Tres variables [Sabatini et al. 2022](https://onlinelibrary.wiley.com/doi/full/10.1111/ddi.13158) ![](imgs/sabatini.jpg){fig-align="center" fig-size="52%"}

## Formatos complejos

[Sabatini et al. 2022](https://onlinelibrary.wiley.com/doi/full/10.1111/ddi.13158) ![](imgs/forest.jpg){fig-align="center" fig-size="52%"}
...
map + inset_element(leg, -1, 0.7, 0.7, 1)
