...
![](https://www.joshuastevens.net/images/js_finalBivariateMap.png) \## Son bastante comunes para reportar resultados de elecciones
...
-   Una de las ventajas de usar la función `bi_class()` es que hace la categorización de las dos variables elejidas de una vez, no así la función `classIntervals()`
:::
