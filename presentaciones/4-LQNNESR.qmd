...
::: {.row .d-flex}
::: {.col-md-6}
::: {style="text-align: right; background-color:#4a4a62;"}
Nick Holt (2017)\
...
msleep %>% group_by(order) %>% 
  summarize(mediana_slp = mean(sleep_total),
...
::: {.column width="65%"}
Al ejecutar funciones es opcional especificar los nombres de los argumentos, pero en funciones con \>1 argumentos, el orden de los mismos importa
:::
:::
...
:::{.callout-note}
## 
Los desarroladores del `tidyverse` están migrando al uso de esta notación abreviada
:::
...
- crear un vector con los nombres delas localidades
...
### Opciones útiles
- Estudiar los mensajes de error más compunes
::: {style="text-align: right"}
...
<blockquote class="twitter-tweet tw-align-center" data-conversation="none" data-dnt="true">

<p lang="en" dir="ltr">

If you are looking for help with an <a href="https://twitter.com/hashtag/rstats?src=hash&amp;ref_src=twsrc%5Etfw">#rstats</a> problem, I recommend that you<br>🎯do *not* email an individual author or OSS maintainer<br>🎯create a reprex demonstrating your problem (naturally none in this email)<br>🎯post on a public forum like RStudio Community or Stack Overflow

</p>

--- Julia Silge (@juliasilge) <a href="https://twitter.com/juliasilge/status/1477778836968259587?ref_src=twsrc%5Etfw">January 2, 2022</a>
...
--- A/Prof Jenny Richmond (@JenRichmondPhD) <a href="https://twitter.com/JenRichmondPhD/status/1491547956763402240?ref_src=twsrc%5Etfw">February 9, 2022</a>
...
::: {style="text-align: right"}
JD Long\
📼 [How Reproducible Examples are the Secret to Faster Learning & Faster Code](https://www.youtube.com/watch?v=0zNPgGa-Cu0)\
29/09/2022
:::
...
Nadie sabe todo de memoria y hay que saber buscan en línea
