...
## Ejemplo: funciones útiles en el paquete `phyloregion`
...
#| echo: true
library(rio)
moluscos = import(file=here("dados","moluscos.txt"),
                  setclass = "data.frame")
...
ambi = import(file=here("dados","ambi.txt"),setclass = "data.frame")
...
- para llamar la función directamente a su script usar:
...
-   Había un excelente paquete con buena documentación [aqui](https://seananderson.ca/2013/10/19/reshape/)
-   Sin emmbargo el paquete `reshape2` ya no se va actualizar..
-   Su funciones fueron incorporadas por el paqute *tidyr*
-   También hay opciones en el paquete [`data.table`](https://cran.r-project.org/web/packages/data.table/vignettes/datatable-reshape.html)
