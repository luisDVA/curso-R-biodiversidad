...
## `r fa(name = "r-project")` no es RStudio
...
![](https://spss-tutorials.com/img/spss-data-editor-data-view.png)
...
Fuente: The Network Encyclopedia
:::
...
- Fáciles de puedan ordenar y que cooperen con búsquedas parciales
