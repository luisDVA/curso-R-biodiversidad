...
– Exploración rápida de datos (*Gabriel – EasyStats, skimR)
...
– Preparación de figuras científicas
	* Ejemplo de figuras complejas mostrando todos los resultados asociados a un análisis de componentes principales (PCA) (e.g., armar panels, combinación de figuras sin usar otro software, paquete ‘patchwork’)
...
* Matrices de correlación entre rasgos para estudios morfométricos (geomorph, mvmorph)
